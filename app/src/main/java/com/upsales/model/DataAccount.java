...
public class DataAccount implements Serializable {
    ...
    @Expose
    private ExternalClientData externalClientData;
    ...
    public ExternalClientData getExternalClientData() {
        return externalClientData;
    }

    public void setExternalClientData(ExternalClientData externalClientData) {
